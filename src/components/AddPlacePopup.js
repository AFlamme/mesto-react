...
return(
  <PopupWithForm name="add" title="Новое место" isOpen={isOpen} container="popup__container popup__form" onClose={onClose} handleSubmit={handleSubmit} buttonText='Сохранить'>
